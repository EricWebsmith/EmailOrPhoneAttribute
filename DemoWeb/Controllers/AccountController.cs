    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.EmailOrPhone };
                if(isEmail)
                {
                ...
                var validator = (UserValidator<DemoWeb.Models.ApplicationUser>)this.UserManager.UserValidator;
                validator.RequireUniqueEmail = false;
